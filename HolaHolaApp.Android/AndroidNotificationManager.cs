    ...
    public class AndroidNotificationManager : INotificationManager
    {
        ...
        public void Show(string title, string message)
        {
            ...
            NotificationCompat.Builder builder = new NotificationCompat.Builder(Android.App.Application.Context, channelId)
                ...
                .SetLargeIcon(BitmapFactory.DecodeResource(Android.App.Application.Context.Resources, Resource.Drawable.abc_ic_menu_copy_mtrl_am_alpha))
